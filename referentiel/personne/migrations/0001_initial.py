    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('situation_matrimoniale', models.CharField(blank=True, choices=[('celibataire', 'Célibataire'), ('marie', 'Marié(e)'), ('divorce', 'Divorcé(e)'), ('veuf', 'Veuf/Veuve'), ('non_renseigne', 'Non renseigné')], default='non_renseigne', max_length=20, null=True)),
                ...
                ('statut_user', models.CharField(blank=True, max_length=10, null=True)),
